				...
				<div class="col-xl-12 col-md-12">
                    <div id="bg_color_{{ $dataS['sub_service_id'] }}" class="widget widget-stats bg-teal">
                        ...
                        <div class="stats-link">
                            <a id="btn_run_{{ $dataS['sub_service_id']   }}" name="btn_run_{{ $dataS['sub_service_id']   }}" data-status="{ $dataS['status'] }}" onclick="alerta( {{ $dataS["patiente_id"] }}, {{ $dataS["service_id"] }}, {{ $dataS["sub_service_id"] }} );">Run Time<i class="fa fa-arrow-alt-circle-right"></i></a>
                        </div>
                    </div>
                </div>
			@endforeach			
