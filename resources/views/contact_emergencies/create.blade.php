...
@section('content')
    ...
    <div class="progress" style="height: 30px; margin-bottom: 20px;">
        ...
        @elseif($urlUser == "patientes" || $contactEmergency->guardian == 1)
            <div class="progress-bar progress-bar-striped bg-success"
                ...
                aria-valuemax="100"
            > Patiente Data </div>
            <div class="progress-bar progress-bar-striped {{$contactEmergency->guardian == 1 ? 'bg-success' : 'bg-info'}}"
                role="progressbar"
                style="width: 33.33%"
                aria-valuenow="33.33"
                aria-valuemin="0"
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
            {!! Form::model($contactEmergency, ['route' => ['contactEmergencies.update', $workerID], 'method' => 'patch']) !!}
