                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name='worker_id'id="worker_id" class="default-select2 form-control"  required="Auth::user()->role_id == 1 ? 'true' : 'false'">
                                            @if (isset($workers) && !empty($workers) && count($workers) >= 1)
                                                <option data-name-service='' value='all' {{ isset($dataSearch['searchWorkerId']) && !empty($dataSearch['searchWorkerId']) && $dataSearch['searchWorkerId'] == 'all' || $dataSearch['searchWorkerId'] == '' ? 'selected' : '' }}>All</option>
