			...
			<div class="panel panel-inverse">
				...
				<div class="panel-heading">
                    ...
                    <div class="panel-heading-btn">
                        ...
                        <a href="{{ route('titleJobs.create') }}" class="btn btn-xs btn-icon btn-circle btn-primary" class="pull-right"><i class="fa fa-plus"></i></a>
                    ...
                    <div class="col-xs-12 ">
                        <table id="data-table-combine" class="table table-striped table-bordered table-td-valign-middle">
                            <thead>
                                <tr>
                                    <th width="1%"></th>
                                    <th class="text-nowrap">Title Job</th>
                                    <th class="text-nowrap">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach($titleJobs as $key => $titleJobs)
                                    <tr>
